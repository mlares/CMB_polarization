...
with open('../out/POL04/data_POL04.pk', 'rb') as arch:
...
plt.tight_layout()
fig.savefig('Zt_POL04_radial.png')  
...
plt.tight_layout()
fig.savefig('hists_POL04_radial.png')  
